...
class MergeError(GigantumException):
    def __init__(self, message):
        # Call the base class constructor while modifying the message to contain
        # the "magic" string the UI looks for to open the merge conflict modal
        super().__init__(f"{UI_MERGE_CONFLICT_STRING} - {message}")
