"""Test call for exercise link unpublished dataset"""
import pytest
...
@pytest.mark.linkUnpublishedDataset
class TestLinkUnpublishedDataset:
    """Includes test methods for basic dataset creation link and its dependent tests with unpublished dataset"""
    ...
    def test_link_unpublished_dataset(self, clean_up_project, clean_up_dataset, clean_up_remote_project,
                                      clean_up_remote_dataset):
        """Test method to create and link an unpublished dataset"""
        ...
        # Publish project
        self.publish_project(dataset_list)
    ...
    def publish_project(self, dataset_list):
