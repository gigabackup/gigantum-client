"""Test call for verifying published dataset becomes available to collaborators"""
import time
import pytest
...
@pytest.mark.verifyPublishedDatasetAvailableToCollaborators
class TestVerifyPublishedDatasetAvailableToCollaborators:
    """Includes test methods for verifying published dataset becomes available to collaborators"""
    ...
    def test_verify_published_dataset_available_to_collaborators(self, clean_up_project, server_data_fixture,
                                                                 clean_up_dataset, clean_up_remote_project,
                                                                 clean_up_remote_dataset):
        """Test method to verifying published dataset available to collaborators"""
        # Create project
        ...
        # Add user2 as read/write collaborator
        ...
        # Add user2 as read collaborator
        dataset_utility = DatasetUtility()
